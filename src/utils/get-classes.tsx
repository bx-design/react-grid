...
export const getGutterClasses = (props: GutterProps): Array<string> => [
  ...
  props.gxSm && props.gxSm !== undefined ? 'gx-sm-' + props.gxSm : '',
  props.gxMd && props.gxMd !== undefined ? 'gx-md-' + props.gxMd : '',
  props.gxLg && props.gxLg !== undefined ? 'gx-lg-' + props.gxLg : '',
  props.gxXl && props.gxXl !== undefined ? 'gx-xl-' + props.gxXl : '',
  props.gxXxl && props.gxXxl !== undefined ? 'gx-xxl-' + props.gxXxl : '',
